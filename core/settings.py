...
SECRET_KEY = 'django-insecure-ei=7xl_g3j-hp0ci*fl8@2zw9q3qoc(kz$#$ogz(7=ve^fo_5h'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Local/dev convenience. Add production hosts via environment-specific settings.
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "[::1]",
